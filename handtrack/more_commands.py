...
while cap.isOpened():
    ...
    if result.multi_hand_landmarks:
        for hand_landmarks in result.multi_hand_landmarks:
            ...
            cv2.putText(frame, f"{direction}", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)

            # Check for swipe gesture
            swipe_gesture = is_swipe(hand_landmarks)
            if swipe_gesture:
                cv2.putText(frame, f"{swipe_gesture} Detected", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
